...
const projectOfTheWeek = () => {
  ...
  return (
    <div className="container mx-auto bg-whiteColor text-center md:text-start">
      <div className="container mx-auto project-of-the-week grid py-20 px-4">
        <div className="border-b border-blackColor pb-20">
          <h1 className="project-of-the-week__title text-4xl sm:text-5xl md:text-6xl font-bold mb-4 pb-10 ">
            Project of the Week
          </h1>
