...
const HeroSection = () => {
  return (
    <div className="bg-greenColor pt-[70px]  z-0">
      <div className="h-screen relative container mx-auto px-4 flex flex-col items-center justify-center  md:flex-row md:justify-start ">
        <div className="flex flex-col w-3/5 text-center text-blackColor space-y-10 md:ml-20  md:text-left md:w-1/2 lg:w-1/3 xl:w-1/4 z-10">
